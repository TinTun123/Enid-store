        ...
        <div id="checkoutPage" class="mt-4 max-w-[1200px] mx-auto px-2">
            <div class="md:flex gap-4 justify-between mx-auto w-full">
                <div class="md:w-[65%]">
                    ...
                    <div id="Items" class="bg-white rounded-lg space-y-4 p-4 mt-4">
                ...
                <div class="md:w-[35%]">
                    <div id="placrorder" class="bg-white rounded-lg p-4">
                        ...
                        <form @submit.prevent="pay()">
                            ...
                            <button :disabled="isProcessing" type="submit" :class="[isProcessing ? 'opacity-70' : 'opacity-100']" class="mt-4 bg-gradient-to-r from-[#FE630C] to-[#FF3200] w-full text-white text-[21px] font-semibold p-1.5 rounded-full">
